    ...
    <div class="check_div">
      ...
      >
        <a-descriptions size="small" title="基本信息" bordered :column="4">
          ...
          <a-descriptions-item label="租车公司名称" :span="4">
            {{ readListData.billName }}
          </a-descriptions-item>
...
import { findDeviceBillPage, createBizBillManully, removebizBill, importBizBillvoucherImage } from '@/api/bizBill.js'
import { findDeviceOrderPage } from '@/api/bizOrder.js'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return findDeviceBillPage(parameter).then(res => {
          return res.result
        })
      },
