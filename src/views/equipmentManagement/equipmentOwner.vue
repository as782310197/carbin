          ...
          <a-col :span="6">
            <a-form-item label="状态">
              ...
              >
                ...
                <a-select-option :value="3">已认证</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
...
import { findMemberPage, updateBizMember, memberAuthPass, memberAuthFailed } from '@/api/bizCarInfo.js'
// 引入权限数据
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return findMemberPage(parameter).then(res => {
          return res.result
        })
      }
    }
  ...
  methods: {
    ...
    handleEdit (record) {
      ...
      this.$nextTick(() => {
        ...
        this.form.setFieldsValue(pick(record, 'id', 'openId', 'gender', 'phone', 'nick', 'password'))
      })
    },
    // 保存按钮
    handleSaveSubmit () {
